...
void Obj::Draw(void)
{
	...
	if (_animMap[_state][_animFrame].first >= 0)
	{
		...
		lpSceneMng.AddDrawQue({ _animMap[_state][_animFrame].first,lpSceneMng.GameScreenOffset.x + _pos.x,lpSceneMng.GameScreenOffset.y + _pos.y , _rad });
	}	
}
...
void Obj::Draw(int id)
{
	...
	lpSceneMng.AddDrawQue({ id,lpSceneMng.GameScreenOffset.x + _pos.x,lpSceneMng.GameScreenOffset.y + _pos.y , _rad });
}
