...
const Vector2<double> mapPosCorUL ={ 0,0 };		// マップ座標の左右隅
const Vector2<double> mapPosCorDR{ CHIP_CNT_X * CHIP_SIZE_X - SCREEN_SIZE_X,CHIP_CNT_Y * CHIP_SIZE_Y - SCREEN_SIZE_Y };		// マップ座標の上下隅
